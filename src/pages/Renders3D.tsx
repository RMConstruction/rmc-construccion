...
const Renders3D = () => {
  useEffect(() => {
    document.title = "Renders 3D | Arquitectura";
  }, []);
      ...
      <div className="pt-20 md:pt-24 pb-12 bg-secondary/50">
        <div className="container-custom">
          ...
          <p className="paragraph max-w-3xl">
            Visualizaciones tridimensionales realistas para ver su proyecto
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-2xl font-display font-bold mb-6">
                ¿Qué es un render 3D y su importancia?
              </h2>
              <p className="mb-6">
                Un render 3D es una representación gráfica tridimensional
                fotorrealista generada por computadora que permite visualizar un
                proyecto antes de su construcción. Estos modelos digitales
                permiten experimentar espacios, texturas, iluminación y ambiente
                de forma inmersiva y realista.
              </p>
              <p className="mb-6">
                En Arquitectura, utilizamos tecnología de vanguardia para crear
                renders 3D de alta calidad que le permiten visualizar cada
                detalle de su proyecto, facilitando la toma de decisiones y
                garantizando que el resultado final cumpla con sus expectativas.
              </p>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Experimente su proyecto como si ya estuviera construido.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Evalúe alternativas de diseño, materiales y acabados de
                      forma visual.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Comparta su visión con inversionistas, colaboradores o
                      familiares.
                    </p>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <p className="text-center text-muted-foreground">
                Imágenes de alta calidad que transmiten profesionalismo y
                atención al detalle.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <p className="text-center text-muted-foreground">
                Visualización precisa de texturas, materiales, iluminación y
                acabados.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <p className="text-center text-muted-foreground">
                Experimente cómo se verá su proyecto finalizado antes de
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="overflow-hidden rounded-lg shadow-md hover:shadow-lg transition-all duration-300">
              ...
              <div className="p-4">
                <p className="font-medium">
                  Diseño de interiores sala de estar
                </p>
              </div>
            </div>
            ...
            <div className="overflow-hidden rounded-lg shadow-md hover:shadow-lg transition-all duration-300">
              ...
              <div className="p-4">
                <p className="font-medium">
                  Área común en desarrollo residencial
                </p>
              </div>
            </div>
          </div>
