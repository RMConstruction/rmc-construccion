...
const Planos2D = () => {
  useEffect(() => {
    document.title = "Planos 2D | Arquitectura";
  }, []);
      ...
      <div className="pt-20 md:pt-24 pb-12 bg-secondary/50">
        <div className="container-custom">
          ...
          <p className="paragraph max-w-3xl">
            Diseño detallado y técnico de planos bidimensionales para una
            visualización clara y precisa de su proyecto.
          </p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-2xl font-display font-bold mb-6">
                Explicación de los planos 2D
              </h2>
              <p className="mb-6">
                Los planos 2D son representaciones técnicas bidimensionales que
                muestran la distribución de espacios, dimensiones, conexiones y
                detalles técnicos de un proyecto. Son esenciales para la fase de
                planificación y construcción.
              </p>
              <p className="mb-6">
                En Arquitectura, desarrollamos planos 2D detallados y precisos
                que sirven como guía fundamental para la ejecución de su
                proyecto, garantizando claridad en la distribución y
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Visualización completa de la distribución de espacios y
                      dimensiones.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Detalles técnicos de cimentación, columnas, vigas y otros
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Planos de instalaciones eléctricas, hidráulicas,
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-md text-center">
              ...
              <p className="text-muted-foreground">
                Utilizamos AutoCAD para crear planos detallados y precisos con
            ...
            <div className="bg-white p-8 rounded-lg shadow-md text-center">
              ...
              <p className="text-muted-foreground">
                Implementamos Revit para modelado de información de construcción
                (BIM) y planos integrados.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md text-center">
              ...
              <p className="text-muted-foreground">
                Empleamos ArchiCAD para un diseño arquitectónico avanzado con
