              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Construcción de estructuras, cimentaciones y elementos de
                      concreto armado.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Transformación y actualización de espacios existentes para
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Expansión de espacios existentes manteniendo la coherencia
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <p className="text-muted-foreground mb-4">
                Utilizamos solo materiales de la más alta calidad para
                garantizar durabilidad y un acabado excepcional.
              </p>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <p className="text-muted-foreground mb-4">
                Implementamos métodos constructivos modernos para optimizar
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <p className="text-muted-foreground mb-4">
                Nuestro enfoque en la calidad y cumplimiento normativo ofrece
                numerosas ventajas.
              </p>
              <ul className="space-y-2">
                <li className="flex items-center gap-2">
