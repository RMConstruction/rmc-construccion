    ...
    >
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            <h3 className="font-display text-2xl font-bold mb-6">Donopoly</h3>
            <p className="text-white/80 mb-6">
              Transformamos espacios con calidad y dedicación. Su visión es nuestra misión.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#home" className="text-white/70 hover:text-primary transition-colors duration-300">
                  Inicio
                </a>
              </li>
              <li>
                <a href="#about" className="text-white/70 hover:text-primary transition-colors duration-300">
                  Sobre Nosotros
                </a>
              </li>
              <li>
                <a href="#portfolio" className="text-white/70 hover:text-primary transition-colors duration-300">
                  Proyectos
                </a>
              </li>
              <li>
                <a href="#testimonials" className="text-white/70 hover:text-primary transition-colors duration-300">
                  Testimonios
                </a>
              </li>
              <li>
                <a href="#contact" className="text-white/70 hover:text-primary transition-colors duration-300">
                  Contacto
                </a>
              </li>
            </ul>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-white/60 text-sm mb-4 md:mb-0">
            © {new Date().getFullYear()} Donopoly. Todos los derechos reservados.
          </p>
